...
namespace BeanCounter
{
    partial class FrmReports
    {
        ...
        private GroupBox gbForecaseOptions;

        private NumericUpDown nudOverages;

        private TextBox tbOverrideBalance;

        private CheckBox cbOverrideBalance;
        ...
        private BackgroundWorker bwBuildCashForecast;

        private StatusStrip statusStrip1;

        //private ToolStripStatusLabel tsslRows;

        //private ToolStripStatusLabel tsslTotal;

        //private ToolStripStatusLabel tsslAverage;

        //private ToolStripStatusLabel tsslMonthly;

        private CheckBox cbOverages;		
